      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-600 mt-1">Gerencie o cardápio do seu restaurante</p>
          </div>
                      ...
                      {product.hasPromotion && product.promotionDiscount ? (
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold text-green-600">
                            R$ {(Number(product.price) * (1 - Number(product.promotionDiscount) / 100)).toFixed(2)}
                          </span>
                        </div>
                      ) : (
