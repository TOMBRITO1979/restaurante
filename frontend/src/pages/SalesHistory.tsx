...
import { Receipt, Calendar, CreditCard, User, Phone, Hash, Filter, FileText, Download, DollarSign, TrendingUp, ShoppingCart, Printer } from 'lucide-react';
...
export const SalesHistory: React.FC = () => {
  ...
  const handlePrintReceipt = async (saleId: string) => {
    try {
      ...
      // Open PDF in new window to print
      ...
      toast.error(error.response?.data?.error || 'Erro ao imprimir recibo');
    }
  };
                ...
                >
                  <Card className="hover:shadow-lg transition-shadow">
                    ...
                    <div className="md:hidden">
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs ml-auto">
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                        ...
                        <button
                          ...
                          className="flex items-center justify-center p-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition"
                  ...
                  {selectedSale?.id === sale.id && (
                    <div className="mt-6 pt-6 border-t border-gray-200">
                      <h4 className="font-semibold mb-4">Itens da Venda</h4>
