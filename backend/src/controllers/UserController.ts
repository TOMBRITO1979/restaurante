...
export class UserController {
  ...
  async create(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      try {
        ...
        log.warn('Erro ao enviar email de boas-vindas', { error: emailError, email: user.email });
      }
  ...
  async activate(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      log.error('Erro ao ativar usuário', { error });
      res.status(500).json({ error: 'Erro ao ativar usuário' });
    }
  }

  async suspend(req: AuthRequest, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      ...
      log.error('Erro ao suspender usuário', { error });
  ...
  async toggleActive(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      log.error('Erro ao alterar status do usuário', { error });
  ...
  async listAll(req: AuthRequest, res: Response): Promise<void> {
    try {
      ...
      log.error('Erro ao listar todos os usuários', { error });
